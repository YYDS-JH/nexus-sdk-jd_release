...
def launch_setup(context, *args, **kwargs):
    ...
    robot_config = os.path.join(pkg_share, 'config', 'master_single_nexus_config.yaml')
    controller_config = os.path.join(pkg_share, 'config', 'master_arm_control_nexus.yaml')
    gripper_config = os.path.join(pkg_share, 'config', 'gripper_config_nexus.yaml')
