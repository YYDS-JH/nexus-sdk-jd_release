...
def launch_setup(context, *args, **kwargs):
    ...
    robot_config = os.path.join(pkg_share, 'config', 'slave_single_ar5_suction_cup_config.yaml')
    controller_config = os.path.join(pkg_share, 'config', 'arm_control_ar5_suction_cup.yaml')
    gripper_config = os.path.join(pkg_share, 'config', 'gripper_config_ar5_suction_cup.yaml')
