...
def launch_setup(context, *args, **kwargs):
    ...
    nexus_arm_human_data_solver_launch = _include('human_data', 'nexus_arm_v17_human_data_solver.launch.py')
    master_controller_launch = _include('robot_controller', 'master_single_nexus.launch.py')
    manager_launch = _include('nexus_manage', 'nexus_nexus-arm_v17_to_ar5_manage.launch.py')
