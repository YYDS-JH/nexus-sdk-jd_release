"""
Teleop Manager Node Launch File - Nexus-Arm V18 to AR5 08L Suction Cup
"""
...
def launch_setup(context, *args, **kwargs):
    ...
    base_name = 'nexus_arm_to_ar5_08l_suction_cup_manager_node'
...
def generate_launch_description():
    ...
    default_config = os.path.join(
        pkg_share, 'config',
        'nexus-arm_v18_to_ar5_08l_suction_cup_manage.yaml')
