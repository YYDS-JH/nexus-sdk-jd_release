...
用法:
  ros2 launch nexus_manage nexus_arm_v18_right_to_ar5_gripper_real_system_cross_subnet.launch.py
  ros2 launch nexus_manage nexus_arm_v18_right_to_ar5_gripper_real_system_cross_subnet.launch.py role:=slave
  ros2 launch nexus_manage nexus_arm_v18_right_to_ar5_gripper_real_system_cross_subnet.launch.py role:=master
...
_MASTER_EXTERNAL_IP = "10.47.223.158"

# Slave 侧（AGV 内网，AR5 端）
_SLAVE_NETWORK_INTERFACE = "eno1"
_SLAVE_EXTERNAL_IP = "10.47.233.141"
...
_MASTER_NODES = [
    ...
    ('nexus_manage',     'nexus_nexus-arm_v18_to_ar5_gripper_manage.launch.py'),
]

_SLAVE_NODES = [
    ('teleop_adapter',   'slave_ar5_gripper_single.launch.py'),
    ('human_data',       'ar5_gripper_human_data_solver.launch.py'),
    ('robot_controller', 'slave_single_ar5_gripper.launch.py'),
]
