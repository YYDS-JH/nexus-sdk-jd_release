...
def launch_setup(context, *args, **kwargs):
    ...
    ar5_arm_launch = _include('teleop_adapter', 'slave_ar5_gripper_single.launch.py')
    ar5_human_data_solver_launch = _include('human_data', 'ar5_gripper_human_data_solver.launch.py')
    slave_controller_launch = _include('robot_controller', 'slave_single_ar5_gripper.launch.py')
    ...
    manager_launch = _include('nexus_manage', 'nexus_nexus-arm_v18_to_ar5_gripper_manage.launch.py')
